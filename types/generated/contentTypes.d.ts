...
export interface ApiCheckinDataCheckinData extends Schema.CollectionType {
  ...
  attributes: {
    id_user: Attribute.Relation<
      'api::checkin-data.checkin-data',
      'manyToOne',
      'plugin::users-permissions.user'
    >;
    lat: Attribute.String;
    long: Attribute.String;
    status: Attribute.Enumeration<['CHECK_IN', 'CHECK_OUT']>;
    outside_area: Attribute.Boolean;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    role: Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    history_checkin: Attribute.Relation<
      'plugin::users-permissions.user',
      'oneToMany',
      'api::checkin-data.checkin-data'
    >;
